...
enfoque utilizado por OWASP ZAP en este proyecto

—, y SAST \(Static Application Security Testing), que analiza el código
...
—como las utilizadas en este proyecto— identifican fallas que solo se
