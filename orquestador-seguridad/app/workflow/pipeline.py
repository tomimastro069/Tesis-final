...
def run_security_pipeline(target_url, nivel="medium", cookies=None, sqlmap_level="basic", progress_callback=None):
    ...
    if progress_callback: progress_callback(80, "Iniciando análisis con SQLMap...")
    def cb_sqlmap(local_pct, msg=""):
        if progress_callback: progress_callback(80 + int(local_pct * 0.20), msg or "Ejecutando SQLMap...")

    sqlmap_raw = run_sqlmap_batch(lista_urls_total, cookies=cookies, proxy="http://zap:8090", sqlmap_level=sqlmap_level, progress_callback=cb_sqlmap)
